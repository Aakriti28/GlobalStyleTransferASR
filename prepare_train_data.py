...
os.makedirs(targetDir_sp, exist_ok=True)
os.makedirs(targetDir_cep, exist_ok=True)
os.makedirs(targetDir_cd, exist_ok=True)
...
for subdir in sorted(subdirList):
    ...
    for fileName in sorted(fileList):
        print(dirName,subdir,fileName, fileName[:-4])
